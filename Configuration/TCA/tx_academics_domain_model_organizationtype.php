    ...
    'columns' => [
        ...
        'l10n_parent' => [
            ...
            'config' => [
                ...
                'foreign_table_where' => 'AND {#tx_academics_domain_model_organizationtype}.{#pid}=###CURRENT_PID### AND {#tx_academics_domain_model_organizationtype}.{#sys_language_uid} IN (-1,0)',
                'default' => 0,
            ],
        ],
        'l10n_diffsource' => [
