    ...
    'columns' => [
        ...
        'l10n_parent' => [
            ...
            'config' => [
                ...
                'items' => [['label' => '', 'value' => 0]],
                'foreign_table' => 'tx_academics_domain_model_domain_model_course_syllabus',
        ...
        'course_category' => [
            ...
            'config' => [
                'type' => 'select',
                'renderType' => 'selectSingle',
                'foreign_table' => 'tx_academics_domain_model_domain_model_course_category',
        ...
        'sdg_goals' => [
            ...
            'config' => [
                ...
                'foreign_table' => 'tx_academics_domain_model_domain_model_sdg',
                'foreign_table_where' => 'ORDER BY number',
                'MM' => 'tx_academics_domain_model_domain_model_coursesyllabus_sdg_mm',
                'size' => 5,
                'maxitems' => 17,
            ],
        ],
        'teaching_methods' => [
            ...
            'config' => [
                'type' => 'select',
                'renderType' => 'selectMultipleSideBySide',
                'foreign_table' => 'tx_academics_domain_model_domain_model_teaching_method',
                'foreign_table_where' => 'ORDER BY sorting',
                'MM' => 'tx_academics_domain_model_domain_model_coursesyllabus_teachingmethod_mm',
                'size' => 5,
                'maxitems' => 99,
            ],
        ],
        ...
        'prerequisite_courses' => [
            ...
            'config' => [
                ...
                'foreign_table_where' => 'ORDER BY title',
                'MM' => 'tx_academics_domain_model_domain_model_coursesyllabus_prerequisite_mm',
                'size' => 5,
                'maxitems' => 99,
            ],
        ],
