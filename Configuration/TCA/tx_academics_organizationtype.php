    ...
    'columns' => [
        ...
        'l10n_parent' => [
            ...
            'config' => [
                ...
                'items' => [['label' => '', 'value' => 0]],
                'foreign_table' => 'tx_spark_organization_type',
                'foreign_table_where' => 'AND {#tx_spark_organization_type}.{#pid}=###CURRENT_PID### AND {#tx_spark_organization_type}.{#sys_language_uid} IN (-1,0)',
                'default' => 0,
            ],
        ],
        'l10n_diffsource' => [
