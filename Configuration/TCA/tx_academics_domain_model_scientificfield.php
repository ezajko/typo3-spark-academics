    ...
    'columns' => [
        ...
        'l10n_parent' => [
            ...
            'config' => [
                ...
                'foreign_table_where' => 'AND {#tx_academics_domain_model_scientificfield}.{#pid}=###CURRENT_PID### AND {#tx_academics_domain_model_scientificfield}.{#sys_language_uid} IN (-1,0)',
                'default' => 0,
            ],
        ],
        'l10n_diffsource' => [
        ...
        'parent' => [
            ...
            'config' => [
                ...
                'renderType' => 'selectSingle',
                'foreign_table' => 'tx_academics_domain_model_scientificfield',
                'foreign_table_where' => 'AND {#tx_academics_domain_model_scientificfield}.{#level} < ###REC_FIELD_level### ORDER BY code, title',
                'items' => [
