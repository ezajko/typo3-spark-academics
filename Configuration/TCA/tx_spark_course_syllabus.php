    ...
    'columns' => [
        ...
        'course_status' => [
            ...
            'config' => [
                'type' => 'select',
                'renderType' => 'selectSingle',
                'foreign_table' => 'tx_spark_course_status',
                'foreign_table_where' => 'ORDER BY sorting',
                'items' => [['label' => '-- Select --', 'value' => 0]],
                'minitems' => 0,
                'maxitems' => 1,
        ...
        'sdg_goals' => [
            ...
            'config' => [
                ...
                'foreign_table' => 'tx_spark_sdg',
                'foreign_table_where' => 'ORDER BY number',
                'MM' => 'tx_spark_coursesyllabus_sdg_mm',
                'size' => 5,
                'maxitems' => 17,
            ],
        ],
        'teaching_methods' => [
            ...
            'config' => [
                ...
                'foreign_table_where' => 'ORDER BY sorting',
                'MM' => 'tx_spark_coursesyllabus_teachingmethod_mm',
                'size' => 5,
                'maxitems' => 99,
            ],
        ],
        ...
        'prerequisite_courses' => [
            ...
            'config' => [
                ...
                'foreign_table_where' => 'ORDER BY title',
                'MM' => 'tx_spark_coursesyllabus_prerequisite_mm',
                'size' => 5,
                'maxitems' => 99,
            ],
        ],
