    ...
    'columns' => [
        ...
        'l10n_parent' => [
            ...
            'config' => [
                ...
                'foreign_table_where' => 'AND {#tx_spark_project}.{#pid}=###CURRENT_PID### AND {#tx_spark_project}.{#sys_language_uid} IN (-1,0)',
                'default' => 0,
            ],
        ],
        'l10n_diffsource' => [
        ...
        'be_users' => [
            ...
            'config' => [
                ...
                'MM' => 'tx_academics_domain_model_domain_model_project_beuser_mm',
                'size' => 5,
                'maxitems' => 99,
            ],
        ],
        ...
        'status' => [
            ...
            'config' => [
                'type' => 'select',
                'renderType' => 'selectSingle',
                'foreign_table' => 'tx_academics_domain_model_domain_model_project_status',
                'items' => [['', 0]],
                'default' => 0,
            ],
        ],
        ...
        'persons' => [
            ...
            'config' => [
                'type' => 'inline',
                'foreign_table' => 'tx_academics_domain_model_domain_model_project_person',
        ...
        'partners' => [
            ...
            'config' => [
                ...
                'MM' => 'tx_academics_domain_model_domain_model_project_partner_mm',
                'size' => 10,
                'maxitems' => 9999,
            ],
        ],
        ...
        'project_type' => [
            ...
            'config' => [
                'type' => 'select',
                'renderType' => 'selectSingle',
                'foreign_table' => 'tx_academics_domain_model_domain_model_project_type',
                'items' => [['-- Select Type --', 0]],
                'default' => 0,
            ],
        ],
        'scientific_fields' => [
            ...
            'config' => [
                ...
                'MM' => 'tx_academics_domain_model_domain_model_project_scientific_field_mm',
                'size' => 5,
                'maxitems' => 9999,
            ],
        ],
