    ...
    'columns' => [
        ...
        'l10n_parent' => [
            ...
            'config' => [
                ...
                'foreign_table_where' => 'AND {#tx_academics_domain_model_course_syllabus}.{#sys_language_uid} IN (-1,0)',
                'default' => 0,
            ],
        ],
        'l10n_diffsource' => [
        ...
        'sdg_goals' => [
            ...
            'config' => [
                ...
                'foreign_table' => 'tx_academics_domain_model_sdg',
                'foreign_table_where' => 'ORDER BY number',
                'MM' => 'tx_academics_domain_model_course_syllabus_sdg_mm',
                'size' => 5,
                'maxitems' => 17,
            ],
        ],
        'teaching_methods' => [
            ...
            'config' => [
                ...
                'foreign_table_where' => 'ORDER BY sorting',
                'MM' => 'tx_academics_domain_model_course_syllabus_teaching_method_mm',
                'size' => 5,
                'maxitems' => 99,
            ],
        ],
        ...
        'prerequisite_courses' => [
            ...
            'config' => [
                ...
                'foreign_table_where' => 'ORDER BY title',
                'MM' => 'tx_academics_domain_model_course_syllabus_prerequisite_mm',
                'size' => 5,
                'maxitems' => 99,
            ],
        ],
