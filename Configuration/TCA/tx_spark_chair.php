    ...
    'types' => [
        '1' => [
            'showitem' => '
                ...
                --div--;Relations, be_users, persons, departments, research_labs, research_groups,
    ...
    'columns' => [
        ...
        'l10n_parent' => [
            ...
            'config' => [
                ...
                'foreign_table_where' => 'AND {#tx_spark_chair}.{#pid}=###CURRENT_PID### AND {#tx_spark_chair}.{#sys_language_uid} IN (-1,0)',
                'default' => 0,
            ],
        ],
        'l10n_diffsource' => [
        ...
        'research_groups' => [
            ...
            'config' => [
                ...
                'MM' => 'tx_spark_chair_research_group_mm',
                'size' => 10,
                'maxitems' => 9999,
            ],
        ],
