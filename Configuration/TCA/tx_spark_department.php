...
return [
    'ctrl' => [
        'title' => 'LLL:EXT:spark_academics/Resources/Private/Language/locallang_db.xlf:tx_spark_department',
        'label' => 'title',
        'tstamp' => 'tstamp',
        'crdate' => 'crdate',
        'sortby' => 'sorting',
    ...
    'columns' => [
        ...
        'l10n_parent' => [
            ...
            'config' => [
                ...
                'foreign_table_where' => 'AND {#tx_spark_department}.{#pid}=###CURRENT_PID### AND {#tx_spark_department}.{#sys_language_uid} IN (-1,0)',
                'default' => 0,
            ],
        ],
        'l10n_diffsource' => [
        ...
        'be_users' => [
            ...
            'config' => [
                ...
                'MM' => 'tx_spark_department_beuser_mm',
                'size' => 5,
                'maxitems' => 99,
            ],
        ],
