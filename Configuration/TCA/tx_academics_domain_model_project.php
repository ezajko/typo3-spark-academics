    ...
    'columns' => [
        ...
        'partners' => [
            ...
            'config' => [
                ...
                'MM' => 'tx_academics_domain_model_projectpartner_mm',
                'size' => 10,
                'maxitems' => 9999,
            ],
        ],
        ...
        'project_type' => [
            ...
            'config' => [
                'type' => 'select',
                'renderType' => 'selectSingle',
                'foreign_table' => 'tx_academics_domain_model_projecttype',
                'items' => [['-- Select Type --', 0]],
                'default' => 0,
            ],
        ],
        'scientific_fields' => [
            ...
            'config' => [
                ...
                'MM' => 'tx_academics_domain_model_project_scientificfield_mm',
                'size' => 5,
                'maxitems' => 9999,
            ],
        ],
