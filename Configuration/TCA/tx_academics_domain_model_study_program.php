    ...
    'columns' => [
        ...
        'l10n_parent' => [
            ...
            'config' => [
                ...
                'foreign_table_where' => 'AND {#tx_academics_domain_model_study_program}.{#pid}=###CURRENT_PID### AND {#tx_academics_domain_model_study_program}.{#sys_language_uid} IN (-1,0)',
                'default' => 0,
            ],
        ],
        'l10n_diffsource' => [
        ...
        'departments' => [
            ...
            'config' => [
                ...
                'MM' => 'tx_academics_domain_model_study_program_department_mm',
                'size' => 5,
                'maxitems' => 99,
                'default' => 0,
            ],
        ...
        'chairs' => [
            ...
            'config' => [
                ...
                'MM' => 'tx_academics_domain_model_study_program_chair_mm',
                'size' => 5,
                'maxitems' => 99,
                'default' => 0,
            ],
        ...
        'study_cycle' => [
            ...
            'config' => [
                'type' => 'select',
                'renderType' => 'selectSingle',
                'foreign_table' => 'tx_academics_domain_model_study_cycle',
        ...
        'scientific_field' => [
            ...
            'config' => [
                ...
                'foreign_table_where' => 'ORDER BY tx_academics_domain_model_scientific_field.sorting',
                'treeConfig' => [
                    'parentField' => 'parent',
                    'appearance' => [
                        'expandAll' => true,
        ...
        'study_types' => [
            ...
            'config' => [
                ...
                'MM' => 'tx_academics_domain_model_study_program_study_type_mm',
                'size' => 5,
                'maxitems' => 99,
                'default' => 0,
            ],
        ...
        'modes_of_study' => [
            ...
            'config' => [
                ...
                'MM' => 'tx_academics_domain_model_study_program_mode_of_study_mm',
                'size' => 5,
                'maxitems' => 99,
                'default' => 0,
            ],
        ...
        'languages' => [
            ...
            'config' => [
                ...
                'MM' => 'tx_academics_domain_model_study_program_language_mm',
                'size' => 5,
                'maxitems' => 99,
                'default' => 0,
                'fieldControl' => [
        ...
        'be_users' => [
            ...
            'config' => [
                ...
                'MM' => 'tx_academics_domain_model_study_program_beuser_mm',
                'size' => 5,
                'maxitems' => 99,
            ],
        ],
